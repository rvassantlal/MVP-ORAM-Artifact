...
quoram_f_1_data = sprintf("%sf_1_bucket_%s_block_%s_zipf_%s_throughput_latency_results.dat", data_dir, Z, B, A)
quoram_f_2_data = sprintf("%sf_2_bucket_%s_block_%s_zipf_%s_throughput_latency_results.dat", data_dir, Z, B, A)
...
set output output_dir . "/comparison.pdf"
...
plot mvp_f_1_data using 1:2 with linespoints title "n = 4 (MVP-ORAM)" dt 1 lw 2 pt 4 ps 0.5, \
	...
	quoram_f_1_data using 1:2 with linespoints title "n = 4 (QuORAM)" dt 4 lw 2 pt 9 ps 0.5, \
	quoram_f_2_data using 1:2 with linespoints title "n = 7 (QuORAM)" dt 5 lw 2 pt 7 ps 0.5
...
plot mvp_f_1_data using 1:4 with linespoints title "n = 4 (MVP-ORAM)" dt 1 lw 2 pt 4 ps 0.5, \
	...
	quoram_f_1_data using 1:3 with linespoints title "n = 4 (QuORAM)" dt 4 lw 2 pt 9 ps 0.5, \
	quoram_f_2_data using 1:3 with linespoints title "n = 7 (QuORAM)" dt 5 lw 2 pt 7 ps 0.5
